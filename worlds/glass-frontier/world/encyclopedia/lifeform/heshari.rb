encyclopedia :heshari do
  name "Heshari"
  summary "Heshari are a sapient people with replaceable vitreous teeth and lungs that capture and expel airborne glass fines. Many glass-country communities have long histories in cutting and assay work, where bite and breath can reveal a piece's grade and internal stress."
  kind :lifeform
  ...
  available_globally
  registry true
  origin "A people of the glass country; the oldest records that mention the yards mention them"
  ...
  descriptive_identity(
    appearance: "Human-framed, with translucent vitreous teeth that grow in " \
                "successive sets. Fresh teeth are nearly clear; years of " \
                "use leave color, chips, and polishing specific to the " \
                "person's diet and work.",
    senses: "The teeth and lined mouth distinguish glass grade, cure, and " \
            "internal stress by a careful bite. The lungs trap inhaled " \
            "fines in mucus that is coughed or rinsed clear.",
    behavior: "Heshari live throughout Kaleidos. Glass-country cutting-yard " \
              "communities maintain assay apprenticeships and several tooth " \
              "customs, while families elsewhere may keep, alter, or leave " \
              "those practices."
  )

  cue "The buyer runs a thumbnail over the cut edge and asks; the heshari cutter bites a coin of the offcut, considers, and names the grade, the stress line, and what the piece will do in cold — and the yard takes the reading over the instrument's."
  cue "At a cutting-yard household's first-shed meal, the child's old tooth joins a family glass jar beside four generations of worn and polished sets."
  affordance "Heshari lungs clear ambient glass fines, and trained tasters can assess grade, cure, and stress from a safe offcut before confirming the reading under cold or tone."
  variation "Glass-country yards maintain dense apprenticeship networks; city and hab families work every trade, and may keep yard practice as household history without entering the occupation."
  variation "Some cutting-yard households keep first-shed teeth, grade worn working sets, and retire the dead's teeth into family glass. These are regional customs, not biological requirements."
