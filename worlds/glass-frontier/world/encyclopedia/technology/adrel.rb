encyclopedia :adrel do
  ...
  prose <<~PROSE
    ...
    Small adrels have reached #{ref :ithara}, where collectors use them inside flooded pressurized enclosures to expose a patch for close inspection. They supply a dry window within suitable water, not a shelter against Lithren's open atmosphere. Sound segmented rims are expensive; a worn one may hold against a smooth demonstration plate and fail on the rough surface a buyer actually needs to examine.
  PROSE
