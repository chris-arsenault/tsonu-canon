encyclopedia :unclosing do
  ...
  prose <<~PROSE
    Resonance work persists while its vibration closes into a stable figure. Unclosing enters one active broad-band working at its medium or field edge and prevents that figure from completing. A braced wall loses its added strength, a kinetic heater stops driving heat, or a broad signal mark goes quiet. The ringglass, housing, and worked material remain where they were.
