encyclopedia :lining do
  name "Lining"
  summary "Lining is the trained laying and keeping of boundary lines in the elves' marker compound — the painted lines that aulm halt at, service organisms obey, and some ring-era machinery still respects. A liner's fresh line is a wall that costs a brushstroke."
  kind :ability
  subkind :technique
  status :complete
  ...
  log "2026-09-23 — Followed the rename of Sweeps to Aulm."
  ...
  descriptive_identity(
    ...
    effect: "A true line reads as a boundary to the ring's living and mechanical servants: " \
            "aulm halt at it, vent crawlers turn along it, and the older door mechanisms " \
  ...
  prose <<~PROSE, section: :dangers, heading: "Cut Slurry"
    ...
    The worst failures come at shaft mouths and nurseries, where a line holds an aulm or a vent crawler away from people who cannot move out of its path. Every liner can name a nursery line in some hab that failed and the child it failed, and the name comes up when a young liner wants to skip a calendar walk. A certified liner's junction mark on a load-bearing stripe is a promise that the line is true, and families who lose someone to a false line go looking for the liner whose mark is on it.
  PROSE
  ...
  cue "The nursery threshold carries a fresh bright line across it, renewed this season, and the hab's aulm turns at it like a cart at a wall."
  affordance "A true line steers the ring's surviving servants for the price of a brushstroke — routing aulm, fencing vent crawlers, holding old doors closed — and a certified liner can re-fence a district's living machinery in a working day."
