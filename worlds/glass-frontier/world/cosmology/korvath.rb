geographic_location :korvath do
  ...
  prose <<~PROSE, section: :present_day, heading: "Istrava"
    #{ref :istrava, "Istrava"} occupies a coast of the warm middle sea, beyond the northern freight economy. Its defense league is dividing over #{ref :aren_talivar, "Aren Talivar"}'s occupation of #{ref :velisar, "Velisar"}. Independent cities are preparing their approaches while relatives from Ashvane bring armed help. No planetary government commands their response.
  PROSE
