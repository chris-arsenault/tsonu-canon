creature :twelve do
  ...
  prose <<~PROSE, section: :present_day, heading: "What It Carries Home"
    ...
    Twelve sometimes brings small hard catches as well as meat. A curved ceramic shoe from beneath the floor fits none of the camp's modern equipment. Dust caught in its collar matches the pale powder inside the shoe's curve. Its next trip left a trace of that powder on the warm grille, then a narrow streak on the underside of a pipe. Beyond the pipe the service sleeve opens against broken old masonry. Someone following its route can smell stolen food there before seeing the nest.

    A wounded person smelling of food can attract its investigation. Twelve touches a ration-stained glove with its nose, then pulls at a fastening it has previously seen somebody open. A person carrying the familiar box may have to set it down and wait while the animal retrieves an old packet from another room. After running through the service sleeve it emerges with its tail humming. Workers clear its usual line across the shelter. A new crate or an armed person in that line can turn an ordinary crossing into an impact against a fragile pressure wall.
  PROSE
