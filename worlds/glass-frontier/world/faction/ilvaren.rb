faction :ilvaren do
  ...
  prose <<~PROSE, section: :operations, heading: "The Animal Books"
    ...
    #{ref :nara_pell} at #{ref :seren} exchanges cultivation observations with the association. The #{ref :ithara_comparative_expedition, "Ithara Comparative Expedition"} sends drawings of recovered organisms through the same correspondence. The Ilvaren's advice has helped keep young #{encyclopedia_ref :nethri} attached to their growing supports during transfers. Two keepers have drawn the dark colonies moving inside those fans in two incompatible ways, and the books print both drawings on facing pages under their makers' names, with a running argument in the margins.
  PROSE
  prose <<~PROSE, section: :tensions, heading: "Buying an Animal Free"
    ...
    Released predators also have human neighbors. Fishers have driven keepers away from a proposed #{encyclopedia_ref :velkur} receiving shore, and one crew cut the keepers' net loose in the night. Tamsa Orlen, who keeps the deepest quarry pool, has held that velkur through a whole season since. It eats a basket of fish a day, paid for from her own purse, and occupies the pool a stranded hauloth calf was meant to have. She is looking for a stretch of cave shore with nobody fishing it and has so far found two, both claimed.
  PROSE
  ...
  log "2026-09-23 — Gave the velkur dispute a named keeper and a concrete cost, and turned the unsettled nethri observation into what the books print."
