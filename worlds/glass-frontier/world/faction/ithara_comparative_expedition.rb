faction :ithara_comparative_expedition do
  ...
  log "2026-09-23 — Restated three lines that defined the work by what it lacks as what it yields."
  ...
  prose <<~PROSE, section: :present_day, heading: "Work People Can Use"
    ...
    Its materials investigators compare shaped pieces from #{ref :damarat, "Damarat"} and examine a joined edge in the #{ref :oravel_hanging, "Oravel Hanging"}. These projects share instruments and field help with the larger excavations. A good result improves a present workshop or tells two methods of making apart, and the ancient maker stays anonymous on the label.
