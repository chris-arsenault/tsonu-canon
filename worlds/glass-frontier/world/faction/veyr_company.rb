faction :veyr_company do
  ...
  prose <<~PROSE, section: :culture, heading: "Parts Learned Elsewhere"
    ...
    The company exchanges recordings and proposed new passages with #{ref :ressa_dorr, "Ressa Dorr"}'s hall. A reply can arrive after the receiving musicians have learned a different ending, leaving two versions in rehearsal. Itharan makers send drawings of rib supports and fitted joints; stage workers return measurements from frames that have survived repeated packing. Their correspondence includes meals, marriages and arguments about whether a slower ending ruins a dance.
  PROSE
  prose <<~PROSE, section: :present_day, heading: "Who Gets Out"
    Members began carrying fugitives through the water gate after soldiers arrested Doran Pesk, the partner of the rigger Talla Veck, for singing a league boast back at its author. Their riggers know how to move a frightened person under a crowd without dropping them. They cooperate with the #{ref :velisar_resistance, "resistance"} and book passage aboard #{ref :ushti, "Ushti"}, paying some fares from performances and charging others to wealthy clients.

    Several members want a successor who can release people bound by Aren. A former prisoner agreed to join companions preparing an approach to Savren; the company supplied an escort, which the #{ref :severance, "Severance"} intercepted before sending that person out by sea. The riggers who prepared the approach are still owed payment for their abandoned equipment. The company's lead singer, Mirel Tavane, says the former prisoner should decide whether to try again, and has written a velith reply mocking the Severance that crowds now demand every night. Talla Veck has packed her rescue lines away and will rig only performances until somebody brings Doran home. Both sides of the quarrel still send wounded people to the paint room. Company riggers now insist on hearing an escorted person's decision with no recruiters in the room.
  ...
  prose <<~PROSE, section: :present_day, heading: "The Two Sides of the Room"
    ...
    Mareva Tereval at #{ref :house_tereval, "House Tereval"} has offered to pay the outward passage of someone who can secure a demonstration. A league officer wants a private viewing and has asked what a hand behind the curve could hold. Mirel wants to take both fees and argue about it afterward; Talla refuses to rig a second audience until the makers agree to one. The company has sent the officer's requested viewing positions with its invitation. The makers still hold the original piece on Lithren and want to travel with any pair prepared for the act.
  PROSE
  ...
  log "2026-09-23 — Named the rigger whose partner's arrest began the rescues, and the lead singer, and took in the riggers' rule about escorted people from the resistance entry."
  log "2026-09-21 — Preserved the company's musical exchange and rescues while making the interrupted escort's consequences particular. Assigned the established Tereval passage offer to Mareva and kept Lethai's makers in possession of the original piece."
end
