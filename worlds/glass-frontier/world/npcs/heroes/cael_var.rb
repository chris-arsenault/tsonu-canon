npc :cael_var do
  name "Cael Var"
  summary "Cael Var is an archive-face cutter at Talven and the maker of Var's Wedge."
  subkind :specialist
  ...
  prose <<~PROSE
    Cael Var cuts recorded ringglass at #{ref :talven, "Talven"}. She made Var's Wedge after metal tools scattered the signal in a damaged archive face. Her hands appear in the recording held by the first plate she lifted with it: a blurred pair of shadows crossing an older work crew's voices.
...
relate :rel_tess_var_located_in_talven, :located_in, :cael_var, :talven, since: 2435 do
  prose "Cael Var leads archive cutting on Talven's Sixth Bench."
end
