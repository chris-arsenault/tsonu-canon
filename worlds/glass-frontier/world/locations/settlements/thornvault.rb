installation :thornvault do
  ...
  prose <<~PROSE, section: :mechanics, heading: "What Is Held"
    The Vault's holdings are extensive and not fully catalogued. The Conclave has spent ninety years cataloguing them and estimates that the work is roughly two-thirds complete.
