installation :heskar_dome do
  ...
  prose <<~PROSE
    ...
    A visitor's #{encyclopedia_ref :savrel} stands beside the mounting. Its shutters can hold a shape while the visitor carries something else into the telescope's view. The correspondent has begun asking for objects beside the shapes, and signals its own name for each before hearing the visitor's. A cup brought up with lunch has remained on the sill for repeated requests to see it filled and emptied.

    A ringglass plate beside the instrument catches brief impressions for #{encyclopedia_ref :echoing}. Replaying a hurried exchange revealed that the correspondent had begun answering before the visitor finished flashing. The answer repeated a request to see the cup's underside; it had been copied as part of a new direction across the hill. The visitor turned the cup over, and the reply changed to the familiar request to bring it closer.
