npc :nereth_valis do
  ...
  prose <<~PROSE, section: :present_day, heading: "Entering the Return"
    ...
    She wants to learn where the departing inhabitants went. On the drawing of Ivara's load, she has circled an empty recess whose packing preserves a narrower object than the surviving cargo. She asks returning cutters to bring pictures of that shape before disturbing anything fitted to it. An object carried from the fort to Damarat and then taken onward could give her the next destination; she keeps space beside the drawing for a match that has yet to arrive.
