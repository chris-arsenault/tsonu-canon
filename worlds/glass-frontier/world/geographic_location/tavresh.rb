geographic_location :tavresh do
  ...
  prose <<~PROSE
    ...
    #{encyclopedia_ref :uthrel} occupy narrow windows and ducts along the sheltered approaches. Divers look for pale jaw skins before entering. The Dhurak crew drove one adult from its window with repeated pressure pulses, clearing a firing slit into the next hall. The displaced hunter wedged itself beneath the floor where their boarding party expected to shelter. Divers still use that window, but pull their legs clear before reaching for the lower sill.
