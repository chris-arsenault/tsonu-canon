thread :itharan_recoveries do
  ...
  prose <<~PROSE, section: :history, heading: "Ancient Acts"
    ...
    #{ref :sahel, "Sahel"} appears first in recoveries and later in #{ref :sahels_breach, "the destruction of essential witnesses during an evacuation"}. Other sites preserve alterations and different combinations of retained states. Local sequences do not establish one succession of governments or one war spanning every ruin. Removed collections and contracted basin settlements survive as evidence without a settled account of the civilization's ultimate fate.

    #{ref :sereyat, "Sereyat"} preserves a changed playing frame used by a seated performer. #{ref :oravel, "Oravel"}'s smaller heat circuit and repaired partition thresholds establish continued occupation after part of the hall changed use. At #{ref :damarat, "Damarat"}, one removed load aboard #{ref :ivara, "Ivara"} establishes an arrival after the fortification's breach. Only that last sequence is presently tied to the witnessed evacuation.
  PROSE
  ...
  prose <<~PROSE, section: :course, heading: "Modern Discoveries"
    The #{ref :ithara_survey, "survey of 2408"} connected retained pieces across separate works. Its founder demonstrated a practical return in 2416 and died in 2424. #{ref :nereth_valis, "Nereth Valis"}'s #{ref :ithara_witnessings, "Witnessings of 2427"} established recurring people and major acts.
  ...
  prose <<~PROSE, section: :present_day, heading: "A Place to Enter"
    The #{ref :ithara_return, "Ithara Return"} became feasible as a gate undertaking in 2434. Preparation continues in 2435. A returned complex could add workshops and dangerous defenses to an already inhabited hub. Its users will have to choose how to inhabit and change it.

    Independent crews now use Ithara to reach many smaller ruins. Some seek complete recoverable works, some sell ordinary finds, and some pursue observations with no expected buyer. The settlement's growth supplies passages and companions beyond the gate undertaking. Dangerous encounters can concern a stolen cargo or a seized camp without explaining anything about the ancient civilization.

    The ancient enemy, ecological forces, ultimate fate and possible origin of resonance remain open for everyone. The evidence may never decide them. Discovering a particular departure route or a machine's function can nevertheless produce a definite result.
  PROSE
