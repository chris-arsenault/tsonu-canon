edict :irals_first_claim do
  ...
  prose <<~PROSE, section: :tensions, heading: "A Piece With Two Uses"
    ...
    Employees who conceal a find can lose their share and place on ordinary freight. Selven sends armed crews to recover pieces he regards as stolen from the expedition. Outside its camps and vessels he must bargain, persuade another carrier or attempt a seizure. Independent excavators have refused the order and continued working with their own equipment. It has no automatic force across Lithren.
  PROSE

  prose <<~PROSE, section: :present_day, heading: "The Price of Help"
    Selven offers equipment to free the workers held in the #{ref :araket_seizure, "Araket Seizure"}, with the First Claim attached to any defensive parts recovered using it. The captives are people to be brought out, not objects covered by the claim. A rescue party can accept the tools, save the workers and still dispute what it must bring back afterward.

    #{ref :ilven_sarith, "Ilven Sarith"} pays promptly for portable mechanisms. Workers who hear his offer before the company's assessment may hide a control in ordinary cargo, persuade their companions to refuse together, or seek a buyer willing to bargain with Selven. Taking the part away can leave a dangerous mechanism unusable, disable a useful shelter or prevent a future armed occupation. The particular machine determines which consequence the departing crew leaves behind.
  PROSE
