...
| `world/cosmology/lithren.rb` | Open-air ruins are non-elven, lack resonance lattices, and predate surviving records. No intact body or written archive has been recovered. A basin survey is underway. Preserve these facts or change them through an explicitly dated new discovery. |
...
Lithren needs **three to four accessible ordinary participants and two to three distinct expedition sites**, with transport, observation and interpretation distributed among their proper owners. Retain the ten veiled subjects. Before M4 fixes ancient evidence, reconcile Lithren's statement that no written archive has been recovered with veiled descriptions of readable archive ice: determine which records are modern and which would constitute an ancient discovery. Do not silently settle the civilization's history through a logistics hook.
